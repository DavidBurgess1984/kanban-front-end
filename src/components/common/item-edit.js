...
const ItemEdit = ({placeholder,index,value,editItemHandler,deleteItemHandler,errors}) => {
   ...
   return (
        <li className="list__item--edit">
            ...
            <input type="text"  value={value} class={(typeof errors.items !== 'undefined' && typeof errors.items[index]  !== 'undefined') ? "text__input text__input--error ": "text__input" } placeholder={placeholder} onChange={(e) => editItemHandler(index,e.target.value)}/>
