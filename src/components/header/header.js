      ...
      boardViewDropdown = (
        <div className="board__toggle-dropdown" ref={props.wrapperRef}>
            <ul class='board__toggle-dropdown-list'>
                <li className="board__toggle-dropdown-list-item" onClick={(e) => props.showEditBoardLightboxVisible(e)}>Edit Board</li>
                <li className="board__toggle-dropdown-list-item board__toggle-dropdown-list-item--red" onClick={(e) => props.showDeleteBoardLightbox(e)}>Delete Board</li>
            </ul>
        </div>
        )
    }
   ...
   return (
    <Fragment>
      ...
      <header className="header">
          <a href='/' className="header__item header__item--left navigation__logo"  alt='logo-icon'/>
          ...
          <div className="header__item header__item--right">
            <a className="header__button header__button--create header__button--create-disabled" onClick={(e) => props.showAddTaskLightbox(e)}>+ Add New Task</a>
          </div>
          <div className="header__item header__item--right">
