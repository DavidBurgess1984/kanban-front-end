    ...
    return (
        <Fragment>
            ...
            <div className="lightbox__content">
                ...
                <ItemList title={'Subtasks'} addItemBtnTxt={'Add New ItemList'} addItem={props.addItem} items={props.subTasks} editItemHandler={props.editSubtask} deleteItemHandler={props.deleteSubtask} errors={props.errors}/>
